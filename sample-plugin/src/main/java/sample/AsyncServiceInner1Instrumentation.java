...
public class AsyncServiceInner1Instrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String ENHANCE_CLASS = "sample.basic.asyncmock.AsyncService$1";
    private static final String INTERCEPT_CLASS = "sample.AsyncServiceInner1Interceptor";
